...
@store1.employees.create(first_name: "Hotaru", last_name: "Adalhard", hourly_rate: 57)
...
@store4.employees.create(first_name: "Random", last_name: "Person", hourly_rate: 41)
@store5.employees.create(first_name: "John", last_name: "Doe", hourly_rate: 60)
